...
~~~
export IMAGE=quay.io/akaris/must-gather-network-metrics:v0.2; oc adm must-gather --image=${IMAGE} -- gather
~~~
...
~~~
export IMAGE=quay.io/akaris/must-gather-network-metrics:v0.2; oc adm must-gather --image=${IMAGE} -- \
...
~~~
export IMAGE=quay.io/akaris/must-gather-network-metrics:v0.2; oc adm must-gather --timeout='20m' --image=${IMAGE} -- \
